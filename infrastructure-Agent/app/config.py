...
class Settings:
	...
	def from_env(cls) -> "Settings":
		...
		settings = cls(
			...
			tenant_name=os.getenv("TENANT_NAME", defaults.tenant_name),
			environment_name=os.getenv("ENVIRONMENT_NAME", defaults.environment_name),
			environment_type=os.getenv("ENVIRONMENT_TYPE", defaults.environment_type),
